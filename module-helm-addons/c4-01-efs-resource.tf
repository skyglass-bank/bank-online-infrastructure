...
data "aws_efs_file_system" "efs_file_system" {
  file_system_id = "fs-0926bddffa7b4a577"
}
...
resource "aws_efs_mount_target" "efs_mount_target" {
  ...
  file_system_id = data.aws_efs_file_system.efs_file_system.id
...
output "efs_file_system_id" {
  ...
  value = data.aws_efs_file_system.efs_file_system.id
}

output "efs_file_system_dns_name" {
  description = "EFS File System DNS Name"
  value = data.aws_efs_file_system.efs_file_system
}
